...
class _DetectScreenPageState extends State<DetectScreen>
  ...
  void initState() {
    ...
    TFLiteHelper.tfLiteResultsController.stream.listen((value) {
      setState(() {
        outputs = value;
        CameraHelper.isDetecting = false; // Set bit to false to allow detection again
      });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(child: Text("Sign Shot,")),
      ),
  ...
  Widget _buildResultsWidget(double width) {
